...
class Achievements {
	public static var achievementsStuff:Array<Dynamic> = [ //Name, Description, Achievement save tag, Hidden achievement
		...
		["Disruption With No misses",		"Beat Disruption on Hard with no Misses.",				'week1_nomiss',			false],
		["Applecore With No misses",				"Beat Applecore on Hard with no Misses.",				'week2_nomiss',			false],
		["Disability With No misses",			"Beat Disability on Hard with no Misses.",				'week3_nomiss',			false],
		["Wireframe With No misses",					"Beat Wireframe on Hard with no Misses.",				'week4_nomiss',			false],
		...
		["WHAT THE HELL",				"Complete a Song with a rating of 100%.",			'ur_good',				false],
